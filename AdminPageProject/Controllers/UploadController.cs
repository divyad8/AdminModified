...
namespace AdminPageProject.Controllers
{
    public class UploadController : Controller
    {
        ...
        // GET: UploadPage
        [HttpGet]
        public async Task<IActionResult> UploadPage(int attendenceid)
        {
        ...
        // POST: UploadPage
        [HttpPost]
        public async Task<IActionResult> UploadPage(int id, IFormFile report, string image, double latitude, double longitude)
        {
